<?php 
   ...
   if(isset($_POST['submit'])){
      if($crud->deleteBM() == true){
            Flasher::setFlash('Data Barang Masuk Berhasil Dihapus!', 'success');
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
   <h1 class="h2">Hapus Barang Masuk</h1>
</div>
...
<?php if(isset($_GET['id'])) : ?>   
   ...
   <form action="" method="post">
      ...
      <a href="index.php?page=barangmasuk" class="btn btn-secondary btn-sm">Batal</a>
   </form>
